...
public class TestIAFacileAntiquite {
	@BeforeEach
	public void init() {
	...
	public void TestPoidsInstruireOuvrier() {
		InfoJoueur j1 = new InfoJoueur();
		InfoJoueur j2 = new InfoJoueur();
		IAFacileAntiquite iatest = new IAFacileAntiquite();
		j1.setEcus(10);
		j2.setEcus(10);
		ArrayList<InfoJoueur> js = new ArrayList<>();
		InfoPlateau p = new InfoPlateau();
	...
	public void TestChoixActionl() {
		...
		when((Integer)mocks.nextInt(100)).thenReturn(0);
		...
		p.getPaquetEmprunt().add(new Emprunt("E", 0, 0, 0));
		...
		assertEquals(iatest.choixAction(p, j1.getOutils(), j1.getOuvriers(), j1.getBatiments(), j1.getNbEcus(), j1.getPtsVictoire(), 3,mocks), "EnvoyerTravailler");
		...
		j1.ajoutNbEcus(7);
		assertEquals(iatest.choixAction(p, j1.getOutils(), j1.getOuvriers(), j1.getBatiments(), j1.getNbEcus(), j1.getPtsVictoire(), 3,mocks), "InstruireOuvrier");
